                        ...
                        <div className='d-flex flex-wrap navbar-outlay'>
                            ...
                            >
                                <NavDropdown
                                    title={
                                        <span>
                                            <IoAddOutline style={{ color: openDropdown === 'shirt-dropdown' ? 'yellow' : 'white', fontSize: '24px' }} />
                                        </span>
                                    }
                                    id="shirt-dropdown"
                                    show={openDropdown === 'shirt-dropdown'}
                                >
                                    <NavDropdown.Item as={NavLink} to='/shop/product/shirt'>Class</NavDropdown.Item>
                                    <NavDropdown.Item as={NavLink} to='/crud-q'>FlashCard/Quiz</NavDropdown.Item>
                                    <NavDropdown.Item as={NavLink} to='/shop/product/ao-ba-lo'>Folder</NavDropdown.Item>
                                </NavDropdown>
                            </div>
                        </div>
                        {/* </Nav> */}
